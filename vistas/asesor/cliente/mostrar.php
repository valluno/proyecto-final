...
<script src="https://cdn.datatables.net/1.10.11/js/jquery.dataTables.min.js"></script>
 ...
 $(document).ready(function(){
  //alert("TABLA");
  $.getJSON('./controlador.php?accion=traer', function (resultado) {
...
"ajax": "./controlador.php?accion=traer",
    "columns": [
        { "data": "nombres" },
        { "data": "usuarios" },
        { "data": "sexo"},
        ...
        { "data": "id_usuario",
            render: function (data) {
                      return '<a href="#" onclick="clieAct('+data+')" data-codigo="'+ data + 
                             '" class="btn btn-info btn-sm editar">Actualizar</a>' 
            }
        },
        { "data": "id_usuario",
            render: function (data) {
                      return '<a href="#" onclick="clieBorrar('+data+')" data-codigo="'+ data + 
